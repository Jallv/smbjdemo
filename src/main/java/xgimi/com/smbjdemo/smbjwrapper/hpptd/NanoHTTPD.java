...
import xgimi.com.smbjdemo.smbjwrapper.utils.log.klog.MapLog;
...
public abstract class NanoHTTPD {
    public static final int BUFFER_SIZE_1M = 1024 * 16;
                        ...
                        asyncRunner.exec(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    if (!(e instanceof SocketException && "NanoHttpd Shutdown".equals(
                                            e.getMessage()))) {
                                        e.printStackTrace();
                                    }
                                } finally {
    ...
    public static class Response {
        ...
        protected void sendAsFixedLength(OutputStream outputStream, int pending) throws IOException {
            if (requestMethod != Method.HEAD && data != null) {
                byte[] buff = new byte[BUFFER_SIZE_1M];
                while (pending > 0) {
                    int read = data.read(buff, 0, ((pending > BUFFER_SIZE_1M) ? BUFFER_SIZE_1M : pending));
                    if (read <= 0) {
                        break;
                    }
                    outputStream.write(buff, 0, read);
        ...
        public enum Status implements IStatus {
            SWITCH_PROTOCOL(101, "Switching Protocols"), OK(200, "OK"), CREATED(201, "Created"), ACCEPTED(202,
                    ...
                    "Unauthorized"), FORBIDDEN(403, "Forbidden"), NOT_FOUND(404, "Not Found"), METHOD_NOT_ALLOWED(405,
    ...
    protected class HTTPSession implements IHTTPSession {
        ...
        public HTTPSession(TempFileManager tempFileManager, InputStream inputStream, OutputStream outputStream,
            ...
            this.inputStream = new PushbackInputStream(inputStream, BUFSIZE);
            this.outputStream = outputStream;
            String remoteIp = inetAddress.isLoopbackAddress() || inetAddress.isAnyLocalAddress()
                    ? "127.0.0.1"
            ...
            try {
                ...
                if (Method.POST.equals(method)) {
                    ...
                    if ("multipart/form-data".equalsIgnoreCase(contentType)) {
                        ...
                        int boundaryContentStart = contentTypeHeader.indexOf(
                                boundaryStartString) + boundaryStartString.length();
                ...
                while (mpline != null) {
                    if (!mpline.contains(boundary)) {
                        throw new ResponseException(Response.Status.BAD_REQUEST, "BAD REQUEST: Content type is " +
                                "multipart/form-data but next chunk does not start with boundary. Usage: GET " +
                                "/example/file.html");
                    }
                    boundarycount++;
                    ...
                    if (mpline != null) {
                        ...
                        if (contentDisposition == null) {
                            throw new ResponseException(Response.Status.BAD_REQUEST,
                                    "BAD REQUEST: Content type is multipart/form-data but no content-disposition info" +
                                            " found. Usage: GET /example/file.html");
                        }
